...
## [2.0.0](https://github.com/Ferdinand99/Sylo/compare/v3.14.0...v2.0.0) (2026-09-03)
...
* insights — voice-channel usage, an hourly view, and on-demand r… ([fb24b38](https://github.com/Ferdinand99/Sylo/commit/fb24b387f2e65394b78b8f3870f38e6c20fb8404))
...
* Kick.com live alerts ([cb46779](https://github.com/Ferdinand99/Sylo/commit/cb4677927121a376d451f5bec33b2f320ebc89bf))
* Kick.com live alerts ([2ae4168](https://github.com/Ferdinand99/Sylo/commit/2ae416820253b4afe65d028b2439e0f81acdf57f))
...
* plain-text (no embed) option for Twitch and Kick alerts ([5311e57](https://github.com/Ferdinand99/Sylo/commit/5311e57edefa19ab87ee36dc74b7e0af4f2c7e3f))
* Prometheus /metrics endpoint, request logging, and richer /health ([bba93ae](https://github.com/Ferdinand99/Sylo/commit/bba93ae5667d82f1663158cef06ac4f08a207e7a))
* Prometheus /metrics endpoint, request logging, and richer /health ([743d3f6](https://github.com/Ferdinand99/Sylo/commit/743d3f629a9cac807c336c48cdb309b8f561e902))
...
* push mappable automod checks to native Discord AutoMod ([c3b5f25](https://github.com/Ferdinand99/Sylo/commit/c3b5f2559997a60fc9a9625cffc1a11b534eaf05))
* push mappable automod checks to native Discord AutoMod ([89b32fd](https://github.com/Ferdinand99/Sylo/commit/89b32fd6d6cf776140ab6a57f3a3bf86c816ef2f))
...
* resolve Reddit, Mastodon and Bluesky handles in the RSS module ([6acaff3](https://github.com/Ferdinand99/Sylo/commit/6acaff3830f70747d8aa7da0f96dfda9a30761d1))
...
* RSS / Atom feed alerts ([57ada7c](https://github.com/Ferdinand99/Sylo/commit/57ada7cea3e9425fe8ea2294ceff4a2b8071af49))
* RSS / Atom feed alerts ([650cbc8](https://github.com/Ferdinand99/Sylo/commit/650cbc8ab40a55ccccb5c01c803d36cc8a61cc7c))
...
* server insights — daily activity charts ([0ef1455](https://github.com/Ferdinand99/Sylo/commit/0ef14558d5af9717a910ad808097ce0e62917a2e))
* server insights — daily activity charts ([a5373bf](https://github.com/Ferdinand99/Sylo/commit/a5373bf374c6ff19130c75f89f8a4a5f288f83c3))
...
* use the bot's avatar as the dashboard favicon ([2040c53](https://github.com/Ferdinand99/Sylo/commit/2040c53b75249e1d74d4559b11a28cd17080c55c))
* use the bot's avatar as the dashboard favicon ([7c1369f](https://github.com/Ferdinand99/Sylo/commit/7c1369fa5f99cd0c61415553828f0edc1c70eb03))
...
* /health rendered JSON instead of the page on an hx-boost sidebar click ([3df2a3b](https://github.com/Ferdinand99/Sylo/commit/3df2a3b21e2f9bf8043f9a3d4ff156120f565c53))
* /health rendered JSON instead of the page on an hx-boost sidebar… ([67d0666](https://github.com/Ferdinand99/Sylo/commit/67d0666574aa1c29fd16bdd39ef74b5f1edea4e4))
...
* sticky messages can bump for other apps' messages, with a per-ch… ([640c224](https://github.com/Ferdinand99/Sylo/commit/640c224dad2598c77f378f9e776b2d9cea39af51))
* sticky messages can bump for other apps' messages, with a per-channel cooldown ([c42fa47](https://github.com/Ferdinand99/Sylo/commit/c42fa4739b3ec9427079a7109802a41c9fe3fb27))
...
* use /auth/discord/callback for the OAuth2 redirect path ([aa8aea7](https://github.com/Ferdinand99/Sylo/commit/aa8aea7967b1d145b450e4863d5fe18d3bc91118))
